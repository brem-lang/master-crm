...
type ResendOptions = {
    ...
    // — used here purely to narrow which company's list to preview, since
    // the actual bulk resend validates each lead against its own company.
...
export function BulkResendRejectedDialog({
    count,
    selectedIds,
    onDone,
    bare = false,
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-lg">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Route the selected rejected leads to an affiliate and
                        advertiser within their own company.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4">
                    {options?.companies && (
                        <div className="grid gap-2">
                            <Label
                                htmlFor="bulk-resend-rejected-company"
                                className="flex items-center gap-1.5 text-xs text-muted-foreground"
                            >
                                <Building2 className="size-3.5" />
                                Preview options for company
                            </Label>
                            <Select
                            ...
                            >
                                <SelectTrigger id="bulk-resend-rejected-company">
                    ...
                    <div className="grid gap-2">
                        <Label
                            htmlFor="bulk-resend-rejected-affiliate"
                            className="flex items-center gap-1.5 text-xs text-muted-foreground"
                        >
                        ...
                        >
                            <SelectTrigger id="bulk-resend-rejected-affiliate">
                                <SelectValue
                                    placeholder={
                                        loadingOptions
                                            ? 'Loading…'
                    ...
                    <div className="grid gap-2">
                        <Label
                            htmlFor="bulk-resend-rejected-advertiser"
                            className="flex items-center gap-1.5 text-xs text-muted-foreground"
                        >
                        ...
                        >
                            <SelectTrigger id="bulk-resend-rejected-advertiser">
                                <SelectValue
                                    placeholder={
                                        loadingOptions
                                            ? 'Loading…'

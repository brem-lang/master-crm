                        ...
                        <>
                            <div className="-mr-1 min-h-0 flex-1 space-y-6 overflow-y-auto pr-1">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    />
                                    <InputError
                                        message={errors.advertisers_url}
                                    />
                                </div>
                                ...
                                <div className="grid gap-2">
                                    ...
                                    />
                                    <InputError
                                        message={errors.release_ftd_url}
                                    />
                                </div>
                                ...
                                <div className="grid gap-2">
                                    ...
                                    />
                                    <InputError
                                        message={errors.send_lead_url}
                                    />
                                </div>

                                <div className="grid gap-2">
                                    <Label htmlFor="update_affiliate_status_url">
                                        Update Affiliate Status API URL
                                    </Label>
                                    <Input
                                        id="update_affiliate_status_url"
                                        name="update_affiliate_status_url"
                                        type="url"
                                        defaultValue={
                                            company?.update_affiliate_status_url ??
                                            ''
                                        }
                                        placeholder="https://{project}.supabase.co/functions/v1/update-affiliate-status"
                                    />
                                    <InputError
                                        message={
                                            errors.update_affiliate_status_url
                                        }
                                    />
                                </div>
